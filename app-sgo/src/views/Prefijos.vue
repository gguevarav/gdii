    ...
    <v-data-table
      ...
      <template
        ...
        <v-toolbar
          ...
          <!-- Dialog de registro de nuevo Prefijo -->
          <v-dialog
            v-model="dialog"
            max-width="500px">
            <v-card>
          ...
          <!-- Termina dialog de registro de nuevo Prefijo -->
        </v-toolbar>
      </template>
      <template
...
<script>
  ...
  export default {
    ...
    computed: {
      formTitle() {
        return this.editedIndex === -1 ? 'Nuevo Prefijo' : 'Editar Prefijo'
      },
    },
    ...
    methods: {
      ...
      eliminarProducto(id) {
        confirm('¿Está seguro que desea eliminar este prefijo?') && axios
